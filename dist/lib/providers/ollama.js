...
exports.completeOllamaChat = completeOllamaChat;
...
async function streamOllamaChat(messages, onToken, timeoutMs, clientSignal) {
...
async function completeOllamaChat(messages, timeoutMs) {
    const controller = new AbortController();
