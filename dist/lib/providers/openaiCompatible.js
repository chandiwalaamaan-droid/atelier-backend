...
exports.streamOpenAICompatibleChat = streamOpenAICompatibleChat;
exports.completeOpenAICompatibleChat = completeOpenAICompatibleChat;
...
async function streamOpenAICompatibleChat(baseUrl, apiKey, model, messages, onToken, timeoutMs, clientSignal) {
...
async function completeOpenAICompatibleChat(baseUrl, apiKey, model, messages, timeoutMs) {
    const controller = new AbortController();
