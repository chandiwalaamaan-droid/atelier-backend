...
// one available.
//
// (Cerebras was removed from the chain — it moved to a paid-only plan.
// cerebras.ts is left in the repo in case a paid key is added back later,
// but it's no longer imported or wired into buildChain().)
//
