...
test('short-turn recovery respects its smaller budget while finishing an interrupted word',async()=>{
 ...
 assert.equal(s.inputs[0].params.maxTokens,256);assert.equal(s.inputs[1].params.maxTokens,320);
